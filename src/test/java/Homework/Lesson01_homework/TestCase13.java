...
public class TestCase13 {
    public static void main(String[] args) throws InterruptedException {
        ...
        String s=driver.findElement(By.id("ctl00_MainContent_fmwOrder_RequiredFieldValidator3")).getText();

        if (s.equals("Field 'Street' cannot be empty.")){
            System.out.println("Test passed");
        }else
            System.out.println("Field 'Street' cannot be empty.");
